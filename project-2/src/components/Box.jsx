      ...
      <div className="w-[26%] border-2 border-blue-500 rounded-2xl overflow-hidden relative">
        ...
        <div className="border-t-2 border-t-blue-500">
          <div className="px-5 py-3 flex items-center justify-between">
            ...
            <Link className="flex items-center border-2 border-blue-400 px-3 py-2 rounded-2xl text-blue-500 font-semibold  gap-2 hover:text-white hover:bg-blue-600 hover:outline-0">
              <BsCart2 />
              Add to cart
            </Link>
          </div>
